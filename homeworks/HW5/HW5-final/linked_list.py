class LinkedList:
    ...
    def append(self, val):
        return LinkedList(self._head, self._tail.append(val)) if self else LinkedList(val, Nil())

    def for_each(self, fun):
        return LinkedList(fun(self._head), self._tail.for_each(fun)) if self else Nil()
